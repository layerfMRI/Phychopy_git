...
autoScreenSize = True
outputPrefix   = 'output'
numTrials=4800                                              #Number of trials of stimulation+rest blocks
bufferDur=0                                              #Duration of additional fixation period immediately after scan starts and following last rest block [TRs]
visStimDur=30                                       #Duration of flickering checkerboard blocks
restDur=540   

defaultScreenRes = [400,300]
# Ask user
...
event.waitKeys(keyList=['return','equal']);                                                                   # Wait for Scanner Trigger.
