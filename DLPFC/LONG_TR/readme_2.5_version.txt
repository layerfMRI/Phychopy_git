...
When you want to run the localizer, select the corresponding pickle file AND se the FLAG on line 29
When you want to change alpha -emember to go-nogo, set the flag on line 33
