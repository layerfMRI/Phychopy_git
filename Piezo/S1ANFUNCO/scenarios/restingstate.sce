...
array {
	...
	sound { wavefile soundstim; speakers = 6; description = "module1"; default_code = "module1"; }module1_audio;#d2
	sound { wavefile soundstim; speakers = 5; description = "module2"; default_code = "module2"; }module2_audio;#d3
	sound { wavefile soundstim; speakers = 2; description = "module3"; default_code = "module3"; }module3_audio;#d4
	sound { wavefile soundstim; speakers = 4; description = "module4"; default_code = "module6"; }module4_audio;
	sound { wavefile soundstim; speakers = 3; description = "module5"; default_code = "module5"; }module5_audio;
	sound { wavefile soundstim; speakers = 1; description = "module6"; default_code = "module4"; }module6_audio;
