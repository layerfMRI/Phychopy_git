...
array {
	...
	sound { wavefile soundstim; speakers = 3; description = "module1"; default_code = "module1"; }module1_audio;#d2
	sound { wavefile soundstim; speakers = 6; description = "module2"; default_code = "module2"; }module2_audio;#d3
	sound { wavefile soundstim; speakers = 5; description = "module3"; default_code = "module3"; }module3_audio;#d4
	sound { wavefile soundstim; speakers = 2; description = "module4"; default_code = "module6"; }module4_audio;
	sound { wavefile soundstim; speakers = 1; description = "module5"; default_code = "module5"; }module5_audio;
...
int total_nr_trials =		25	;												
#run1A															
#array <int> finger [total_nr_trials] = 	{	3, 8,	2, 8,	1, 8,	3, 8,	2, 8,	1, 8,	3, 8,	2, 8,	1, 8,	2, 8,	1, 8,	3, 8,	7	};
#run1B															
array <int> finger [total_nr_trials] = 	{	3, 8,	4, 8,	2, 8,	4, 8,	2, 8,	3, 8,	4, 8,	2, 8,	3, 8,	4, 8,	2, 8,	3, 8,	7	};
#run2A															
...
array <string> modules[6]={"R D1 tip", "R D2 tip", "R D3 tip", "R D4 tip", "R D5 tip", "nothing"	};#{"module1", "module2", "module3", "module4", "module5", "module6"	};
